...
const Category = () => {
  ...
  return (
      ...
      <div className="relative overflow-hidden bg-white" style={{backgroundColor: 'white' , margin: '20px', marginLeft: '5vw'}}>
      ...
      <div className="bg-white" style={{backgroundColor: 'white' , margin: '20px', marginLeft: '5vw'}}>
